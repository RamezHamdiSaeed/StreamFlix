...
class CollectionViewTableViewCell: UITableViewCell {
    ...
    func setupCollectionView() {
        ...
        self.collectionView.register(UINib(nibName: TitleCollectionViewCell.identifier, bundle: nil),
...
extension CollectionViewTableViewCell: UICollectionViewDataSource,
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        if let viewModel = self.viewModel as? CollectionViewTableViewCellViewModel {
            ...
            if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: row?.cellIdentifier() ?? "",
                                                             for: indexPath) as? RowViewCell {
                cell.setup(with: row)
