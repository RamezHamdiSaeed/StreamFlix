...
class CollectionViewTableViewCellViewModel: RowViewModel {
    ...
    var collectionViewCellPressedAction: ((Movie) -> Void)?
    ...
    init( movies: [Movie], collectionViewCellPressedAction: ((Movie) -> Void)? = nil) {
        self.movies = movies
    ...
    func buildViewModels() {
        ...
        let sectionViewModel = SectionViewModel(sectionModel: sectionModel,
                                                rowViewModels: self.getMoviesRowViewModels())
